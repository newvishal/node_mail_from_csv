...
const senderEmailAddress = 'vishalsingh1812@gmail.com';    // this will show up in the target user's inbox as who sent the email
const emailVars = {
    name: 'My Event Name',
    date: '03-30-2020',
    time: '3:00 PM',
...
const sendEmailsToTargetUsers = async () => {
    ...
    eventRegistrations = [{
        ...
        name: "Test User",
        email: 'srivastavashutosh80@gmail.com'
    }];
    return new Promise(async (resolve, reject) => {
        try{
            ...
            for (let i = 0, len = eventRegistrations.length; i < len; ++i) {
                ...
                var emailResponse = await mailHelper.sendMail(mailOptions);
